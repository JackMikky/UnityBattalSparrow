...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void Move()
		{
			...
			// move the player
			_controller.Move(inputDirection.normalized * (_speed * Time.fixedDeltaTime) + new Vector3(0.0f, _verticalVelocity, 0.0f) * Time.fixedDeltaTime);
		}
		...
		private void JumpAndGravity()
		{
			...
			if (_verticalVelocity>=-17f&&_verticalVelocity <= _terminalVelocity)
			{
